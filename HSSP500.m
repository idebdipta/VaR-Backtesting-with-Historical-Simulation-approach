...
ZoomInd   = (DatesTest >= datestr('01-June-2016','local')) & (DatesTest <= datestr('31-December-2016','local'));
...
vbt2016 = varbacktest(ReturnsTest(Ind2016),[Historical95(Ind2016),Historical99(Ind2016)],...
   'PortfolioID','S&P, 2016, Jun - Dec','VaRID',{'Historical 95%','Historical 99%'},'VaRLevel',[0.95 0.99]);
runtests(vbt2016)
